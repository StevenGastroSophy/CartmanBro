...
def MAXMIN(compareCurrency, SBSSCBCS, EXTREME, replytxtlist, disconnectlist):
...
def compare(inputmsg):
    ...
    MAXMIN(compareCurrency, SB, 'MIN' replytxtlist, disconnectlist)
    MAXMIN(compareCurrency, SS, 'MAX' replytxtlist, disconnectlist)
    MAXMIN(compareCurrency, CB, 'MIN' replytxtlist, disconnectlist)
    MAXMIN(compareCurrency, CS, 'MAX' replytxtlist, disconnectlist)
